    ...
    <div className="container mt-4">
      <div className="jumbotron jumbotron-fluid">
        <div className="container bg-body">
          ...
          <p className="lead">
            <NextLink href={"/customer"} className="btn btn-dark btn-lg" role="button">GO TO CUSTOMERS</NextLink>
          </p>
          <div className="container px-4">
            <div className="row gx-2">
              <div className="col">
              <div className="p-3">
                <div className={classNames({"card":true},{[style.card]:true},{'bg-primary bg-gradient':true},{'text-white':true})}>
      ...
      <div className="jumbotron jumbotron-fluid mt-4">
        <div className="container bg-body">
          ...
          <p className="lead">
            <NextLink href={"/api"} className="btn btn-dark btn-lg" role="button">GO TO API</NextLink>
          </p>
        </div>
      </div>
    </div>
